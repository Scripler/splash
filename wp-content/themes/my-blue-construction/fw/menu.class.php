<?php
    class menu extends Walker{
        ...
        function __construct( $args ) {
            ...
            $this -> morelabel  = isset( $args['more-label'] ) ? $args['more-label'] : __( 'More' , "mythemes" );
            $this -> limit      = isset( $args['number-items'] ) ? $args['number-items'] : 4;
        ...
        function get_terms_menu( $class = '' , $subclass = 'children' , $current = 'current' , $before = '' , $after = '' , $more = -1 ){

            if( $more == -1 ){
                $more = __( 'More' , "mythemes" );
            }
            ...
            if( is_home() || is_front_page() ){
                ...
                $home .= '<a href="' . home_url() . '">' . $this -> beforeitem . __( 'Home' , "mythemes" ) . $this -> afteritem . '</a>' ;
                $home .= '</li>';
            }else{
